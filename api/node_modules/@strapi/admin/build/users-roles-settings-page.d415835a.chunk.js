"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[8853],{34254:function(ve,G,s){s.r(G),s.d(G,{default:function(){return Tt}});var e=s(32735),a=s(30126),T=s(53038),P=s(19108),k=s(95162),x=s(64092),O=s(91779),B=s(56932),E=s(84642),p=s(8365),A=s(10710),S=s(97037),K=s(2846),J=s(15367),w=s(40501),q=s(92802),b=s(67879),I=s(20108),ye=s(60216),y=s.n(ye);const _=(0,e.createContext)({}),ee=({children:t,value:n})=>e.createElement(_.Provider,{value:n},t),Q=()=>(0,e.useContext)(_);ee.propTypes={children:y().node.isRequired,value:y().object.isRequired};var $=s(48395),Re=s(9435),Ce=s(9379),Pe=s(79624),Se=s(23940),Te=s.n(Se);function be(t){switch(t){case"application":return"Application";case"plugin::content-manager":return"Content manager";case"plugin::content-type-builder":return"Content types builder";case"plugin::documentation":return"Documentation";case"plugin::email":return"Email";case"plugin::i18n":return"i18n";case"plugin::upload":return"Upload";case"plugin::users-permissions":return"Users-permissions";default:return Te()(t.replace("api::","").replace("plugin::",""))}}var Ae=be,Me=(t,n)=>{const o=Object.keys(n).sort().map(r=>({name:r,isOpen:!1}));return{...t,collapses:o}},L=s(77981),Le=s(98978),te=s.n(Le),se=s(31014),ne=s(99320),De=s(19594),Ze=s(33795),F=s.n(Ze),U=s(8471);const ae=(0,U.iv)`
